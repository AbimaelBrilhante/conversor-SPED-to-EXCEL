...
class Sped:
    ...
    def exportar_excel(self):
        try:
            ...
            mysel = c.execute("select COD_PART,COD_MOD,SER,NUM_DOC,CHV_NFE,DT_DOC,DT_E_S,VL_DOC,IND_PGTO,VL_MERC,"
                              "IND_FRT,VL_FRT,VL_SEG,VL_OUT_DA,VL_BC_ICMS_100,VL_ICMS_100,VL_BC_ICMS_ST_100,"
                              "VL_ICMS_ST_100,VL_IPI_100,VL_PIS_100,VL_COFINS_100,VL_PIS_ST,VL_COFINS_ST,NUM_ITEM,"
                              "COD_ITEM,DESCR_COMPL,QTD,UNID,VL_ITEM,VL_DESC,CST_ICMS,CFOP,COD_NAT,VL_BC_ICMS,ALIQ_ICMS,"
                              "VL_ICMS,VL_BC_ICMS_ST,ALIQ_ST,VL_ICMS_ST,CST_IPI,VL_BC_IPI,ALIQ_IPI,VL_IPI,"
                              "CST_PIS,VL_BC_PIS,ALIQ_PIS_170,QUANT_BC_PIS,ALIQ_PIS,VL_PIS,CST_COFINS,VL_BC_COFINS,"
                              "ALIQ_COFINS_170,QUANT_BC_COFINS,ALIQ_COFINS,VL_COFINS,COD_CTA,VL_ABAT_NT from sped_relatorio ")
            cabecalho = ('COD_PART','COD_MOD','SER','NUM_DOC','CHV_NFE','DT_DOC','DT_E_S','VL_DOC','IND_PGTO','VL_MERC',
                         'IND_FRT','VL_FRT','VL_SEG','VL_OUT_DA','VL_BC_ICMS_100','VL_ICMS_100','VL_BC_ICMS_ST_100',
                         'VL_ICMS_ST_100','VL_IPI_100','VL_PIS_100','VL_COFINS_100','VL_PIS_ST','VL_COFINS_ST','NUM_ITEM',
                         'COD_ITEM','DESCR_COMPL','QTD','UNID','VL_ITEM','VL_DESC','CST_ICMS','CFOP','COD_NAT','VL_BC_ICMS','ALIQ_ICMS',
                         'VL_ICMS','VL_BC_ICMS_ST','ALIQ_ST','VL_ICMS_ST','CST_IPI','VL_BC_IPI','ALIQ_IPI','VL_IPI',
                         'CST_PIS','VL_BC_PIS','ALIQ_PIS_170','QUANT_BC_PIS','ALIQ_PIS','VL_PIS','CST_COFINS','VL_BC_COFINS',
                         'ALIQ_COFINS_170','QUANT_BC_COFINS','ALIQ_COFINS','VL_COFINS','COD_CTA','VL_ABAT_NT')
            for x,c in enumerate(cabecalho):
                worksheet.write(0, x, c)

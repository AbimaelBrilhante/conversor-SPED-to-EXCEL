...
class App:
    def __init__(self,master=None):
        ...
        self.button_explore = Button(self.container,
                                text="Browse Files",bg="#4c4c4c",fg="white",width=15,
                                command=lambda:[self.fdb_1(),(main.Sped('sped_relatorio.db').adicionar_bd()),self.fdb_2()])
        ...
        self.button_exportar = Button(self.container,
                             ...
                             command=lambda:[main.Sped('sped_relatorio.db').exportar_excel(),self.fdb_3()])
